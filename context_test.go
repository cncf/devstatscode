...
func TestInit(t *testing.T) {
	...
	defaultContext := lib.Ctx{
		...
		SkipAPILangs:             false,
		ForceAPILangs:            false,
		SkipAPIComments:          false,
		SkipAPIReviews:           false,
		SkipAPIForks:             false,
		SkipAPIReleases:          false,
		SkipAPIStars:             false,
		SkipAPIRepoStats:         false,
		SkipAPIRepoEvents:        false,
		SkipAPIIssuesPRs:         false,
		GHAPIAllRepos:            true,
	...
	var testCases = []struct {
		...
		},
		{
			...
			map[string]string{
				...
				"GHA2DB_GHAPISKIPCOMMENTS":   "1",
				"GHA2DB_GHAPISKIPREVIEWS":    "1",
				"GHA2DB_GHAPISKIPFORKS":      "1",
				"GHA2DB_GHAPISKIPRELEASES":   "1",
				"GHA2DB_GHAPISKIPSTARS":      "1",
				"GHA2DB_GHAPISKIPREPOSTATS":  "1",
				"GHA2DB_GHAPISKIPREPOEVENTS": "1",
				"GHA2DB_GHAPISKIPISSUESPRS":  "1",
			...
			dynamicSetFields(
				...
				map[string]interface{}{
					...
					"SkipAPILangs":      true,
					"ForceAPILangs":     true,
					"SkipAPIComments":   true,
					"SkipAPIReviews":    true,
					"SkipAPIForks":      true,
					"SkipAPIReleases":   true,
					"SkipAPIStars":      true,
					"SkipAPIRepoStats":  true,
					"SkipAPIRepoEvents": true,
					"SkipAPIIssuesPRs":  true,
		...
		{
			"Setting legacy ghapi2db recent repos scope",
			map[string]string{"GHA2DB_GHAPI_RECENT_REPOS_ONLY": "1"},
			dynamicSetFields(
				t,
				defaultContext.CopyContext(),
				map[string]interface{}{"GHAPIAllRepos": false},
			),
		},
		{
