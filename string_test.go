...
func TestPrepareQuickRangeQuery(t *testing.T) {
	...
	var testCases = []struct {
		...
		},
		{
			...
			from:     "2015",
			to:       "2016",
			expected: " (a.b.c >= '2015-01-01 00:00:00' and a.b.c < '2016-01-01 00:00:00')  (c.d.e >= '2015-01-01 00:00:00' and c.d.e < '2016-01-01 00:00:00') ",
			hours:    "8760.000000",
		},
		{
		...
		},
		{
			...
			from:     "1982-07-16",
			to:       "2017-12",
			expected: "and ( (a.b.c >= '1982-07-16 00:00:00' and a.b.c < '2017-12-01 00:00:00')  and x is null) or  (c.d.e >= '1982-07-16 00:00:00' and c.d.e < '2017-12-01 00:00:00') ",
			hours:    "310128.000000",
		},
		{
			...
			from:     "1982-07-16",
			to:       "2017-12",
			expected: "and ( (a.b.c >= '1982-07-16 00:00:00' and a.b.c < '2017-12-01 00:00:00')  and x is null) or  (c.d.e >= '1982-07-16 00:00:00' and c.d.e < '2017-12-01 00:00:00')  and '1982-07-16 00:00:00' - '2017-12-01 00:00:00'",
			hours:    "310128.000000",
		},
		{
