GO_LIB_FILES=pg_conn.go error.go mgetc.go map.go threads.go gha.go json.go time.go context.go exec.go structure.go log.go hash.go unicode.go const.go string.go annotations.go env.go ghapi.go io.go tags.go trailers.go yaml.go ts_points.go convert.go restore.go signal.go ghawriter.go project_filter.go eventid.go computed.go
...
GO_TEST_FILES=context_test.go gha_test.go map_test.go mgetc_test.go threads_test.go time_test.go unicode_test.go string_test.go regexp_test.go annotations_test.go env_test.go convert_test.go error_test.go project_filter_test.go eventid_test.go computed_test.go
GO_DBTEST_FILES=pg_test.go series_test.go computed_db_test.go
...
ghapi2db: cmd/ghapi2db/ghapi2db.go cmd/ghapi2db/restore.go cmd/ghapi2db/heartbeat.go cmd/ghapi2db/feed.go cmd/ghapi2db/issues.go ${GO_LIB_FILES}
	 ${GO_ENV} ${GO_BUILD} -o ghapi2db cmd/ghapi2db/ghapi2db.go cmd/ghapi2db/restore.go cmd/ghapi2db/heartbeat.go cmd/ghapi2db/feed.go cmd/ghapi2db/issues.go
