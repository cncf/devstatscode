...
ghapi2db: cmd/ghapi2db/ghapi2db.go cmd/ghapi2db/restore.go cmd/ghapi2db/heartbeat.go cmd/ghapi2db/feed.go ${GO_LIB_FILES}
	 ${GO_ENV} ${GO_BUILD} -o ghapi2db cmd/ghapi2db/ghapi2db.go cmd/ghapi2db/restore.go cmd/ghapi2db/heartbeat.go cmd/ghapi2db/feed.go
