...
func TestRepoHit(t *testing.T) {
	...
	var testCases = []struct {
		...
		},
		{
			exact:    true,
			fullName: "abc/def",
			forg:     map[string]struct{}{`regexp:^(a\/b|abc\/def|x\/y\/z)$`: {}},
			frepo:    map[string]struct{}{},
			hit:      true,
		},
		{
		...
		},
		{
			...
			forg:     map[string]struct{}{"regexp:abc": {}},
			frepo:    map[string]struct{}{"regexp:def": {}},
			hit:      true,
		},
		{
			fullName: "XabcX/XdefX",
		...
		},
		{
			fullName: "abc",
			forg:     map[string]struct{}{},
			frepo:    map[string]struct{}{"regexp:abc": {}},
			hit:      true,
		},
		{
			fullName: "abcd",
		...
		{
			fullName: "abc",
			forg:     map[string]struct{}{"regexp:abcd": {}},
			frepo:    map[string]struct{}{},
		},
		{
			fullName: "abc",
			forg:     map[string]struct{}{},
			frepo:    map[string]struct{}{"regexp:abcd": {}},
		},
		{
			fullName: "abc/def",
			forg:     map[string]struct{}{"regexp:^abc$": {}},
		...
		{
			fullName: "abc/xyz",
			forg:     map[string]struct{}{`regexp:^(abc|def\/ghi|j\/l)$`: {}},
			frepo:    map[string]struct{}{},
			hit:      true,
		},
		{
		...
		},
		{
			...
			forg:     map[string]struct{}{},
			frepo:    map[string]struct{}{"regexp:fluentd": {}},
			excludes: map[string]bool{"abc/def": true},
			hit:      true,
		},
		{
			fullName: "Fluentd-Org/some-FLuentd-plugin-v2",
			forg:     map[string]struct{}{"regexp:(?i)fluentd": {}},
			frepo:    map[string]struct{}{"regexp:(?i)fluentd": {}},
			excludes: map[string]bool{"abc/def": true},
			hit:      true,
		},
	}
